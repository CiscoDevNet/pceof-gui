define(['angular'],
	function () {
        ...
        regexps['ip-prefix'] = '(('+regexps.ipv4cidr + ')|(' + regexps.ipv6cidr + '))';
        regexps['ip-address'] = '(('+regexps.ipv4 + ')|(' + regexps.ipv6 + '))';

        for(var expr in regexps){
            regexps[expr] = '^' + regexps[expr] + '$';
        }

        return {
            regexps: regexps,
            updateTopoInterval: 5000
        };
